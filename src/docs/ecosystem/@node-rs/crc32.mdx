---
title: '@node-rs/crc32'
description: Fastest crc32 implementation in NodeJS.
---

<a href="https://www.npmjs.com/package/@node-rs/crc32" target="_blank">
  <img alt="npm Downloads" src="https://img.shields.io/npm/dw/@node-rs/crc32" />
</a>
...
> Fastest crc32 implementation in NodeJS.

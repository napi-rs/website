---
title: '@node-rs/bcrypt'
description: Fast and safe crc32 implementation in NodeJS.
---

<a href="https://www.npmjs.com/package/@node-rs/bcrypt" target="_blank">
  <img alt="npm Downloads" src="https://img.shields.io/npm/dw/@node-rs/bcrypt" />
</a>
...
> Fast and safe crc32 implementation in NodeJS.

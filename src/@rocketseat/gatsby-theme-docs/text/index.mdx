...
<p><span style={{ fontSize: '24px', fontWeight: 'bold' }}>NAPI-RS</span> is a minimal
library for building pre-compiled <NodeJS /> addons in <Rust /></p>.
...
⚡️ Zero copy data between `Rust` & `NodeJS`
...
> ✅ _Means official tested in napi-rs repo._

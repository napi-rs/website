...
O `ExternalRef` mantém o <NodeLink href="https://nodejs.org/api/n-api.html#napi_ref">`napi_ref`</NodeLink> para o objeto criado pela função <NodeLink href="https://nodejs.org/api/n-api.html#napi_create_external">`napi_create_external`</NodeLink>.

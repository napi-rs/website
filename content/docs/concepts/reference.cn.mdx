...
`ExternalRef` 持有指向由 <NodeLink href="https://nodejs.org/api/n-api.html#napi_create_external">`napi_create_external`</NodeLink> 函数所创建对象的 <NodeLink href="https://nodejs.org/api/n-api.html#napi_ref">`napi_ref`</NodeLink>。

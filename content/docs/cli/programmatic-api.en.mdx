...
| <Yellow>js</Yellow> | JavaScript binding file |
| <Blue>dts</Blue> | TypeScript definition file |
| <Rust>exe</Rust> | Executable binary |
| <Purple>wasm</Purple> | WebAssembly module |
...
| dtsHeader | string | No | | Custom header string for the <Green>.d.ts</Green> file; used when neither header-file option is set |

...
export function ZeroConfigBuildCard({
  title,
  description,
  emoji,
  lugeReveal,
  ...
  return (
    ...
    >
      <div className={`feature__visualization ${isCardActive ? 'active' : ''}`}>
        ...
        <div
          className={`terminal ${commandTriggered ? 'terminal--active' : ''}`}
        >
          ...
          <div
            className={`command-wrapper ${!commandTriggered ? 'active' : ''}`}
          ...
          <span
            className={cx('terminal__ready-label', {
              active: commandTriggered,
            })}
          >
        ...
        <div
          className={`connection-line ${commandTriggered ? 'active' : ''}`}
        />
      </div>

...
export const SvgPinkIndicator: React.FC<SvgPinkIndicatorProps> = ({ active }) => {
  return (
    <>
      ...
      >
        {/* Background group with drop shadow filter */}
        ...
        {/* Rectangle group with inner shadow filter */}
        ...
        {/* Border rectangle for the indicator */}
        <rect
          x="130.134"
          y="12.0518"
          width="30.0083"
        ...
        {/* Main indicator rectangle - only visible when active */}
        {active && (
          <rect
            x="110.513"
            y="22.439"
        ...
        {/* Glow effect for the main rectangle - only visible when active */}
        {active && (

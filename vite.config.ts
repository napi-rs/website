...
export default defineConfig({
  ...
  fmt: {
    ...
    ignorePatterns: [
      ...
      // All three locales share the identical byte-0 `<script>` island shape, so
      // exempt every localized variant — not just en — for consistency and to
      // stay safe against oxfmt version drift.
      'pages/en/docs/concepts/webassembly.md',
      'pages/cn/docs/concepts/webassembly.md',
      'pages/pt-BR/docs/concepts/webassembly.md',

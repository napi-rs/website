...
<a href="https://affine.pro/" target="_blank"><AffineLogo /></a> is using **NAPI-RS** to their Electron Desktop App and Node.js server high performance addons.

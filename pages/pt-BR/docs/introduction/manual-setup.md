...
o workflow completo de release, [`napi new`](/docs/cli/new) geralmente é mais
rápido.
...
Veja [Assíncrono e concorrência](/docs/more/async-concurrency) antes de
...
3. Execute [`napi create-npm-dirs`](/docs/cli/create-npm-dirs).
4. Baixe os artefatos da CI e execute [`napi artifacts`](/docs/cli/artifacts).
5. Siga o [guia de release](/docs/deep-dive/release) e leia todos os efeitos
   colaterais de [`napi pre-publish`](/docs/cli/pre-publish) antes de publicar.
...
cruzada](/docs/cross-build) e teste o pacote final em cada runtime que você
afirma suportar.

## O que ler em seguida

- [Testes e depuração](/docs/more/testing-debugging)
- [Integrações com aplicações e bundlers](/docs/more/integrations)
- [Solução de problemas](/docs/more/troubleshooting)
- [Configuração do NAPI-RS](/docs/cli/napi-config)

...
| ---------------------- | ----------------------------------------- | -------------- | :--------------------------------------: | -------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `path`                 | <span class="chalk-green">`<path>`</span> | `string`       | Yes for non-interactive/programmatic use |                            | Empty destination directory, resolved from the current working directory.                                                  |

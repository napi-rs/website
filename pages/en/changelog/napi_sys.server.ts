...
// FILTER STRING for this page (matches legacy getStaticProps('napi-sys') — the
// route stem `napi_sys` maps to the hyphenated crate name).
export const loader = defineHandler(() => loadChangelogHtml('napi-sys', 'en'))

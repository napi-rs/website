...
| --------------------------------------------------- | --------------------------------------- | ------------------------------- | ----------------------- | ----------------------- |
| `x86_64-apple-darwin`                               | `macos-latest`，不加标志                | `-x`¹                           | 不加标志                | 不支持                  |
| `aarch64-apple-darwin`                              | `macos-latest`，不加标志（原生）        | `-x`¹                           | 不加标志                | 不支持                  |
| `x86_64-pc-windows-msvc`                            | `windows-latest`，不加标志              | `-x`²                           | `-x`²                   | 不加标志                |
| `i686-pc-windows-msvc`                              | `windows-latest`，不加标志              | `-x`²                           | `-x`²                   | 不加标志                |
| `aarch64-pc-windows-msvc`                           | `windows-latest`（x64），不加标志       | `-x`²                           | `-x`²                   | 不加标志                |
...
| `x86_64-unknown-freebsd`                            | FreeBSD 15 虚拟机任务，不加标志（原生） | `-x` + zig⁴                     | `-x` + zig⁴             | `-x` + zig⁴             |

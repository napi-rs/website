...
- macOS x64/arm64 ✅
- Windows is blocked by: https://github.com/ziglang/zig/issues/10881
...
Special thanks for our team member [@messense](https://github.com/messense) who has been working on `cargo-xwin` which is enabled us to build Windows native addons on non-Windows systems.

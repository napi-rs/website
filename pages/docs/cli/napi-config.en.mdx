...
| Filed                | Description                                                                                                                                                                                                                |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`               | The binary file name of generated `.node` file. Eg <Green>`[NAME].[TRIPLE?].node`</Green>                                                                                                                                  |
| `triples.defaults`   | Whether to enable the default triples. <br />The default triples is `['x86_64-apple-darwin', 'x86_64-unknown-linux-gnu', 'x86_64-pc-windows-msvc']`.<br />The default value of `triples.defaults` is <Green>`true`</Green> |
